...
Zunächst muss man z.B. mit dem
[Gradle-Plugin von Spring Boot](#Image-für-Kubernetes-erstellen) ein Docker-Image
erstellen:
...
```powershell
    ...
    # einfacher: Skaffold oder helmfile
...
ist z.B. _Micrometer_ geeignet, das mit _Spring Framework_ ab Version 6 integriert
ist. Mit _Spring Boot Actuator_ kann man dann auf solche Rohdaten zugreifen:
