...
//        gradle wrapper --gradle-version=8.0-milestone-4 --distribution-type=bin
...
dependencies {
    ...
    // FIXME NullPointerException, wenn Requests von Spring-basierten GraphQL-Clients empfangen werden
